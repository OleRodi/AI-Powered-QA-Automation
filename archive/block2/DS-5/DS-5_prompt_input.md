# Prompt Template â€” Test Plan from a Jira Ticket
...
## Acceptance Criteria                                                              As an admin user, I want to see all programs in a clear list so that I can quickly find and manage them.
